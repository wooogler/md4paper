...
![번역 화면 — 번역할 섹션 선택과 용어집](docs/images/04-translate.png)
...
- **용어집** — 변환할 때 Abstract·Introduction 본문과 섹션 제목에서 핵심 용어를 자동으로 뽑아
  둡니다. 번역 전에 한국어 표기와 처리 방식(번역 / 음역 / 원문 유지 / 첫 등장 시 병기)을
  검토·수정하고 **"이 용어집으로 번역 실행"** 을 누르면, 문서 전체가 그 표기로 통일됩니다.
- 번역이 끝나면 **결과 (원문·번역)** 탭과 상단 **3 · 뷰어** 탭에서 EN | KO를 나란히 놓고 검수합니다.
  (스크롤이 비율로 동기화됩니다.)
...
Gemini(flash-lite)를 쓰면 10분의 1 수준이 됩니다.
